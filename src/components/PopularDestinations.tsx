...
const PopularDestinations = () => {
  ...
  const destinations = [
    ...
    },
    {
      id: 3,
      name: "Ibiza, Spain",
      image: "https://images.unsplash.com/photo-1544873504-c0c5f9b9cf71?auto=format&fit=crop&w=800&q=80",
      properties: "95+ properties"
    },
    {
      id: 4,
      name: "Capri, Italy",
      image: "https://images.unsplash.com/photo-1580500550469-c7a0e564a82e?auto=format&fit=crop&w=800&q=80",
              ...
              <div className="relative h-80 overflow-hidden rounded-2xl">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-6">
                  ...
                  <div className="flex items-center text-white/80 group-hover:text-white transition-colors">
                    <span className="font-inter text-sm font-medium">Explore Now</span>
