  ...
  const steps = [
    {
      icon: Search,
      title: "Search",
      description: "Find the perfect stay from our curated collection of luxury properties worldwide.",
      number: "01"
    },
    {
      icon: CreditCard,
      title: "Book",
      description: "Secure your reservation with our safe and seamless online payment system.",
      number: "02"
    },
    {
      icon: Sparkles,
      title: "Enjoy",
      description: "Relax and create unforgettable memories at your dream destination.",
      number: "03"
    }
  ];
      ...
      <div className="container mx-auto px-6">
          ...
          {steps.map((step, index) => (
            <div key={index} className="relative text-center group">
              ...
              <div className="absolute -top-4 -right-4 w-12 h-12 bg-gradient-to-r from-coral to-sunset rounded-full flex items-center justify-center shadow-lg">
                <span className="text-white font-playfair font-bold text-lg">{step.number}</span>
              </div>
        ...
        <div className="text-center mt-16">
          <div className="flex items-center justify-center gap-2 text-muted-foreground font-inter">
            ...
            <div className="w-2 h-2 bg-ocean rounded-full animate-pulse" style={{ animationDelay: '1s' }}></div>
          </div>
        </div>
      </div>
    </section>
